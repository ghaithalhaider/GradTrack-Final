...
import { doc, getDoc, collection, query, where, getDocs, setDoc, updateDoc, Timestamp, onSnapshot, deleteDoc } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";
...
async function loadProjectsFromFirestore() {
    ...
    try {
        ...
        const studentDoc = await getDoc(doc(db, "students", user.uid));
        if (!studentDoc.exists()) {
            throw new Error("بيانات الطالب غير موجودة");
        }
